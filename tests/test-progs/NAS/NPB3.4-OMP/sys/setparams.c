...
void write_cg_cpp_info(FILE *fp, char class);
...
void get_info(char *argv[], int *typep, char *classp) {
    ...
    *classp = *argv[2];
    ...
    if (!strcmp(argv[1], "sp") || !strcmp(argv[1], "SP"))
        ...
        *typep = CG;
    else if (!strcmp(argv[1], "cg_cpp") || !strcmp(argv[1], "CG_CPP"))
        *typep = CG_CPP;
    else if (!strcmp(argv[1], "ua") || !strcmp(argv[1], "UA"))
        *typep = UA;
...
/* 
 * write_cg_cpp_info(): Write CG_CPP specific info to config file
 */
